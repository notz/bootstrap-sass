...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    sass: {
      dev: {                            // Target
        ...
        files: {                         // Dictionary of files
          ...
          'dist/css/<%= pkg.name %>-app.css': 'assets/stylesheets/app.scss'
        }
      },
      dist: {                            // Target
        options: {                       // Target options
      ...
      dist: {
        ...
        files: {
          src: [
            ...
            'dist/css/<%= pkg.name %>-app.css',
            'dist/css/<%= pkg.name %>-app.min.css',
          ]
        }
      }
    },
    ...
    csscomb: {
      sort: {
        ...
        files: {
          ...
          'dist/css/<%= pkg.name %>-app.css': 'dist/css/<%= pkg.name %>-app.css'
        }
      }
    },
    ...
    watch: {
      ...
      sass: {
        files: 'assets/stylesheets/bootstrap/*.scss',
        tasks: 'sass'
      }
    }
